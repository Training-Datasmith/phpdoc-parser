...
use function trim;
class Assert_Tag_Value_Node implements Php_Doc_Tag_Value_Node
{
    use Node_Attributes;
    ...
    public function __construct(Type_Node $type, string $parameter, bool $is_negated, string $description, bool $is_equality)
    {
        $this->type = $type;
    ...
    public function __toString(): string
    {
        ...
        return trim("{$is_negated}{$is_equality}{$this->type} {$this->parameter} {$this->description}");
    }
    /**
